...
MONGO_DB_URI = getenv("mongodb+srv://musicrobot:musicrobot@cluster0.l54hfu9.mongodb.net/?retryWrites=true&w=majority", None)
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001921278927"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("Uta")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6046532356").split())
...
SUPPORT_CHANNEL = getenv(
    "https://t.me/RealmBotUpdates", None
)  # Example:- https://t.me/TheYukki
SUPPORT_GROUP = getenv(
    "https://t.me/RealmBotSupport", None
